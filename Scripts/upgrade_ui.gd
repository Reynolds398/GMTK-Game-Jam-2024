...
func _on_pea_right_button_pressed():
	upgrade_weapon(p_right_upgrade, "p_right")
...
func _on_cata_right_button_pressed():
	upgrade_weapon(c_right_upgrade, "c_right")
...
func _on_bould_right_button_pressed():
	upgrade_weapon(b_right_upgrade, "b_right")
...
func upgrade_weapon(upgrade_array, upgrade_name):
